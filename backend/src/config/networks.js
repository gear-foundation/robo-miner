export const DEFAULT_WORLD_CONFIG = [
  [40, 64, 100, 77, 19, 4, 1, 40, 10, 1000],
  [1, 2, 1, 4, 1, 12],
];

export const DEFAULT_REDEEM_RATES = { scrst: 6, bcrst: 30, hcrst: 150 };
export const DEFAULT_REDEEM_CONFIG = {
  REDEEM_UNIT: '1000000000000',
  REDEEM_RATES: DEFAULT_REDEEM_RATES,
  REDEEM_REQUEST_TTL_MS: 600000,
  REDEEM_WORKER_INTERVAL_MS: 5000,
  REDEEM_BURN_TIMEOUT_MS: 180000,
  REDEEM_LEASE_MS: 240000,
...
export const MAINNET = {
  ...
  DOCUMENT_ID: 'mainnet',
  DISCOVERY_PORT: 8781,
  WORLD_CODE_ID: '0xd1255c81d69594019a90e94aa06c682bde08037492b48cb53e6d24d90caac22f',
  ...
  REDEEM_TREASURY_ADDRESS: '0x249579d43b0f3418f6e94b269c93714f106ee631',
